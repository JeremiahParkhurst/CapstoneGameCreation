...
public class PatrolReflectProjectileAI : MonoBehaviour, ITakeDamage, IPlayerRespawnListener
{
    // Parameters
    ...
    /*
    public Transform ProjectileBlockLocation;
    ...
    */
    ...
    public void OnTriggerEnter2D(Collider2D other)
    {
        ...
        if (projectile != null && projectile.Owner.GetComponent<Player>() != null)
        {
            ...
            projectile = (Projectile)Instantiate(Projectile, ProjectileFireLocation.position, ProjectileFireLocation.rotation);
